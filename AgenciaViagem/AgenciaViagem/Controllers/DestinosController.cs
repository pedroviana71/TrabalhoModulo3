...
namespace AgenciaViagem.Controllers
{
    public class DestinosController : Controller
    {
        ...
        public DestinosController(BancoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Nome,Cidade,Estado,Hotel,QuantidadeDias")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nome,Cidade,Estado,Hotel,QuantidadeDias")] Destino destino)
        {
            if (id != destino.ID)
            {
                return NotFound();
